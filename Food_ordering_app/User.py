...
class User:
    def __init__(self):
        self.user={}
        self.login=False
    def Register(self):#fuction to register new user
        print("*"*50)
    ...
    def Login(self):#fuction to login if registered, menu to order food is shown when user login successfully
        print("*"*50)
    ...
    def menu(self):#menu driven if login is successfull
        ...
        if choice==1:
            ...
            print("wrong choice")
    def place_order(self):#fuction to place order
        print("*"*50)
    ...
    def order_history(self):
        ...
        self.menu()
    def update_profile(self):#fuction to update the user profile
